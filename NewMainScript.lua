...
local function downloadPremadeProfiles(commit)
    ...
    local success, response = pcall(function()
        return game:HttpGet('https://api.github.com/repos/skidrewrite/japan/contents/profiles/premade?ref=' .. commit)
    end)
...
if not shared.VapeDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/skidrewrite/japan')
	end)

	local commit = 'main'
	local ok, res = pcall(function()
		return game:HttpGet('https://api.github.com/repos/skidrewrite/japan/commits/main', true)
	end)
